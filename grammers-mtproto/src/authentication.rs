...
fn key_for_fingerprint(fingerprint: i64) -> Option<rsa::Key> {
    Some(match fingerprint {
        ...
        // Custom
        -3591632762792723036 => rsa::Key::new("", "65537").unwrap(),
        // Custom
        -6205835210776354611 => rsa::Key::new("", "65537").unwrap(),
        _ => return None
    })
}
